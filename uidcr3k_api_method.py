...
def banner():
	os.system("clear")
	print("")
        print("%s\033[1;32m    ____  _   __      ______________  ______"%(M))
        print("%s\033[1;91    / __ \/ | / /     / ____/  _/ __ \/ ____/"%(M))
        print("%s\033[1;35m  / / / /  |/ /_____/ /_   / // /_/ / __/"%(M))
        print("%s\033[1;91m / /_/ / /|  /_____/ __/ _/ // _, _/ /___"%(M)) 
