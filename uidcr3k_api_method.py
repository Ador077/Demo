...
def banner():
	os.system("clear")
	print("")
        print("%s\033[1;32m    ____  _   __      ______________  ______
        print("%s\033[1;91    / __ \/ | / /     / ____/  _/ __ \/ ____/
        print("%s\033[1;35m  / / / /  |/ /_____/ /_   / // /_/ / __/   
        print("%s\033[1;91m / /_/ / /|  /_____/ __/ _/ // _, _/ /___   
        print("%s\033[1;91m \____/_/ |_/     /_/   /___/_/ |_/_____/   
        print("%s                               
	print("%s╔══════════════════════════════════════════╗"%(Z))
